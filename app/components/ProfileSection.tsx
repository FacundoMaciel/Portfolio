		...
		<div className="w-full py-8 md:py-0 bg-white dark:bg-gray-900 px-6 pt-16 sm:pt-0">
			<div className="space-y-8 text-center">
				...
				<div className="space-y-3">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Facundo Maciel</h1>
					<h2 className="text-lg md:text-xl text-gray-600 dark:text-gray-400">Semi Senior Software Engineer</h2>
					<div className="h-px w-16 bg-gray-200 dark:bg-gray-700 mx-auto my-4" />
					<h2 className="text-lg md:text-xl text-gray-600 dark:text-gray-400">English level B2 Upper Intermediate</h2>
					<p className="text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-xs mx-auto leading-relaxed">
						3+ years designing and developing scalable web systems, contributing to backend, frontend, and full-stack projects.
					</p>
				</div>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-sm text-gray-600 dark:text-gray-400">Corrientes, Argentina</span>
					</div>
