	...
	const experiences = [
		{
			...
			company: 'Geti solutions',
			period: '2024 - Present',
			highlights: 'Working on scrapping and masive data extraction projects using Node.js, Puppeteer, and more.',
		},
		{
			role: 'Front End Developer',
			company: 'Axionline',
			period: '2023 - 2024',
			highlights: 'Developed responsive web applications and mobile using React, React Native, Tailwind CSS, Astro, Next.js, and more.',
		},
		{
			role: 'Full Stack Developer',
			company: 'Freelance',
			period: '2022 - 2024',
			highlights: 'Built scalable web applications using JavaScript, TypeScript, Node.js, various databases, and frameworks.',
		},
	];
