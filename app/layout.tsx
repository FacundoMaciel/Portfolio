...
export const metadata: Metadata = {
	...
	authors: [{ name: 'Facundo Maciel' }],
	creator: 'Facundo Maciel',
	openGraph: {
		title: 'Facundo Maciel - Developer Portfolio',
		description: 'Passionate developer creating simple and effective solutions. Explore my projects and development approach.',
		url: 'https://portfoliofcm.vercel.app/',
		siteName: 'Facundo Maciel - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Facundo Maciel - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
