...
const About = () => {
  return (
    <div name="sobre mi" className="w-full h-screen bg-white text-gray-700 dark:bg-gray-800">
      <div className="max-w-screen-lg p-4 mt-2 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-4">
          <p className="text-4xl font-bold inline border-b-4 border-cyan-300 dark:text-cyan-300 dark:border-white">
            Sobre mi
          </p>
        </div>
